...
#include "op3_ball_detector/kudos_vision_ball_position.h"
#include "op3_ball_detector/kudos_vision_head_pub.h"
...
public:
  ...
  int processTracking();
  int processTracking_hand_over_authority_to_python();
...
protected:
  ...
  void ballPositionCallback(const op3_ball_detector::kudos_vision_ball_position::ConstPtr &msg);
  void kudosVisionHeadCallback(const op3_ball_detector::kudos_vision_head_pub::ConstPtr &msg);
  void ballTrackerCommandCallback(const std_msgs::String::ConstPtr &msg);
  void publishHeadJoint(double pan, double tilt);
  void publishHeadJoint_hand_over_python(double pan, double tilt);
  void scanBall();
  ...
  ros::Subscriber kudos_vision_ball_position_sub_;
  ros::Subscriber kudos_vision_head_sub_;
  ...
  double vision_desire_pan;
  double vision_desire_tilt;
